...
- Step 3: Specify your paths to the downloaded state-transition data (and 3000 BAGEL data samples) in [`modeling/data/dataset_info.py`](https://github.com/Silin159/DynaVieW/blob/main/modeling/data/dataset_info.py).

- Step 4: Create a yaml file to specify your training data mixture in [`modeling/data/configs`](https://github.com/Silin159/DynaVieW/tree/main/modeling/data/configs), e.g., [`modeling/data/configs/pt_mix_st.yaml`](https://github.com/Silin159/DynaVieW/blob/main/modeling/data/configs/pt_mix_st.yaml).
...
- Step 3: Specify your paths to the downloaded VinaBench (VWP) or LEGO data in [`modeling/data/dataset_info.py`](https://github.com/Silin159/DynaVieW/blob/main/modeling/data/dataset_info.py).

- Step 4: Create a yaml file to specify your training data mixture in [`modeling/data/configs`](https://github.com/Silin159/DynaVieW/tree/main/modeling/data/configs), e.g., [`modeling/data/configs/vinabench.yaml`](https://github.com/Silin159/DynaVieW/blob/main/modeling/data/configs/vinabench.yaml) or [`modeling/data/configs/lego.yaml`](https://github.com/Silin159/DynaVieW/blob/main/modeling/data/configs/lego.yaml).
