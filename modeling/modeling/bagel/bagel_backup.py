...
class Bagel(PreTrainedModel):
    ...
    def prepare_prompts(self, curr_kvlens, curr_rope, curr_stsegs, prompts, tokenizer, new_token_ids, vwm_mask, add_special):
        ...
        for prompt, curr_kvlen, curr_position_id, st_seg in zip(prompts, curr_kvlens, curr_rope, curr_stsegs):
            ...
            if vwm_mask:
                ...
                for sid, seg in enumerate(st_seg):
                    if seg[0] == "text":
                        if sid == len(st_seg)-1:
                            attention_mask[:, curr_mask:curr_mask+seg[1]] = 1  # prompt
                        else:
                            pass  # not attend to previous transitions
                    elif seg[0] == "image":
    ...
    def prepare_vit_images(self, curr_kvlens, curr_rope, curr_stsegs, images, transforms, new_token_ids, vwm_mask):
    ...
    def prepare_vae_images(self, curr_kvlens, curr_rope, curr_stsegs, images, transforms, new_token_ids, timestep=0, vwm_mask=False):
    ...
    def prepare_vae_latent(self, curr_kvlens, curr_rope, curr_stsegs, image_sizes, new_token_ids, vwm_mask):
        packed_text_ids, packed_text_indexes = list(), list()
    ...
    def prepare_vae_latent_cfg(self, curr_kvlens, curr_rope, curr_stsegs, image_sizes, vwm_mask, attn_ctx):
        ...
        for (H, W), curr_kvlen, curr_position_id, st_seg in zip(image_sizes, curr_kvlens, curr_rope, curr_stsegs):
            ...
            if vwm_mask:
                ...
                if attn_start == 0 and st_seg[0][0] == "text":
    ...
    def prepare_start_tokens(self, curr_kvlens, curr_rope, curr_stsegs, new_token_ids, vwm_mask, complete):
